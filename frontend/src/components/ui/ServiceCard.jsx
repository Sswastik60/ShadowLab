...
export default function ServiceCard({ service }) {
  ...
  return (
    <div className="glass-panel rounded-2xl p-5 relative overflow-hidden group bg-neutral-950 border-neutral-900">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[11px] text-neutral-400 font-mono">{service.runtime || service.version}</span>
          </div>
        </div>

        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border bg-black border-neutral-900">
          {isHealthy ? (
            <>
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        {service.instances && (
          <div className="rounded-xl bg-black p-2.5 border border-neutral-900">
            <span className="text-neutral-400 text-[10px]">Workers / Containers</span>
        ...
        {service.cpuUsage !== undefined && (
          <div className="rounded-xl bg-black p-2.5 border border-neutral-900">
            <span className="text-neutral-400 text-[10px]">CPU Utilization</span>
        ...
        {service.load !== undefined && (
          <div className="rounded-xl bg-black p-2.5 border border-neutral-900">
            <span className="text-neutral-400 text-[10px]">Database Load</span>
        ...
        {service.connections !== undefined && (
          <div className="rounded-xl bg-black p-2.5 border border-neutral-900">
            <span className="text-neutral-400 text-[10px]">Connections</span>
        ...
        {service.latency !== undefined && (
          <div className="rounded-xl bg-black p-2.5 border border-neutral-900">
            <span className="text-neutral-400 text-[10px]">Avg Latency</span>
